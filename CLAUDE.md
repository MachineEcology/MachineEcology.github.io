...
This is a Jekyll-based static website for the Machine Ecology Lab at the University of Southern Denmark. The site uses the remote theme`lgalke/swiss` and is hosted on GitHub Pages.
